...
$name = date('Y-m-d-H-i-s',time())."学生名单"; // 上传文件的文件名
...
// 					$sql="INSERT INTO te(a,b,c) VALUES ('{$strs[0]}','{$strs[1]}','{$strs[2]}')";
					$sqlstr =  "insert into yq_info(stuno,stuname,stusex,grade,specialty,stupassword) values('{$strs[0]}','{$strs[1]}','{$strs[2]}','{$strs[3]}','{$strs[4]}','$defaultPassword')";
