...
<input class="Pagination smaller regular orange" type="button" id="searchChair-btn" value="查询" onclick="query_chName()">
...
?>		
				...
				<td width="20%;" colspan="2"><input class="Pagination small regular orange" id=<?php echo $myrow['id']?> value="添加考勤信息"type="button" onclick='add_attendance(this.id)' /></td>
			</tr>
<?php }?>
			<tr>
...
function query_chName() {
	...
	$("#tab1").load("m_attendance_add.php?page=1&chName="+name);
...
function add_attendance(id) {
	...
	$("#tab1").load("m_attendance_upload.php?id="+v);
